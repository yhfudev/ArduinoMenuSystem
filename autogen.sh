...
echo "=========== libmenusystem MY_PREFIX=${MY_PREFIX}"
...
if [ 0 = 1 ]; then
  ...
  echo "=========== compiling libmenusystem MY_PREFIX=${MY_PREFIX}"
  ...
  echo "=========== installing libmenusystem MY_PREFIX=${MY_PREFIX}"
  make install
  echo "=========== DONE installing libmenusystem MY_PREFIX=${MY_PREFIX}"
fi
